...
use cubeb_core::ffi::{cubeb, cubeb_channel_layout, cubeb_data_callback, cubeb_device, cubeb_device_changed_callback,
                      cubeb_device_collection, cubeb_device_collection_changed_callback, cubeb_device_type,
                      cubeb_devid, cubeb_log_callback, cubeb_log_level, cubeb_state_callback, cubeb_stream,
                      cubeb_stream_params};
